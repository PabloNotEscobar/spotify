...
export function AdminButton ({ isActive = false, clickHandler }: AdminButton) {
    return (
        <button
            className={`p-2 cursor-pointer text-white opacity-70 hover:opacity-100 transition-opacity duration-150 ${
